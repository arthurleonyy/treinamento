...
public enum ExceptionValidacoes implements AplicacaoExceptionValidacoes {
  ...
  ERRO_SALDO_CONTA_INSUFICIENTE("erro.conta.inexistente", null, AplicacaoExceptionValidacoes.SEVERIDADE_ERRO),
  ERRO_CONTA_INEXISTENTE("erro.saldo.conta.insuficiente", null, AplicacaoExceptionValidacoes.SEVERIDADE_ERRO),
  // Mensagens Alterta
