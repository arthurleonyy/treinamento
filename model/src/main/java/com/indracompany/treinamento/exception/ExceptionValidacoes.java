...
public enum ExceptionValidacoes implements AplicacaoExceptionValidacoes {
  ...
  ERRO_CONTA_DESTINO_NAO_EXISTE("erro.conta.destino.nao.existe", null, AplicacaoExceptionValidacoes.SEVERIDADE_ERRO),
  ERRO_AGENCIA_OU_NUMERO_CONTA_NAO_INFORMADO_CORRETAMENTE("erro.agencia.numero.conta.nao.informado", null, AplicacaoExceptionValidacoes.SEVERIDADE_ERRO),
  ERRO_CPF_CLIENTE_JA_EXISTE("erro.cpf.cliente.existe", null, AplicacaoExceptionValidacoes.SEVERIDADE_ERRO),
  ERRO_EMAIL_JA_EXISTE("erro.email.existe", null, AplicacaoExceptionValidacoes.SEVERIDADE_ERRO),
