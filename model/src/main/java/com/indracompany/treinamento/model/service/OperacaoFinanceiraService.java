...
@Service
public class OperacaoFinanceiraService extends GenericCrudService<OperacaoFinanceira, Long, OperacaoFinanceiraRepository> {
	...
	private void salvarOperacao(Conta conta, TipoOperacaoFinanceira operacao, double valor, double saldoAnterior) {
