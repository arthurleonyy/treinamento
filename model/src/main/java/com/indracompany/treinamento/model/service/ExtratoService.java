...
public class ExtratoService extends GenericCrudService<Extrato, Long, ExtratoRepository> {
	...
	public void gerarExtratoDeposito(double saldoAnterior, double saldoAtual, TipoTransacao transacao, LocalDateTime data, double valor) {
	...
	public void gerarExtratoSaque(double saldoAnterior, double saldoAtual, TipoTransacao transacao, LocalDateTime data, double valor) {
	...
	public void gerarExtratoTransferencia(double saldoAnterior, double saldoAtual, TipoTransacao transacao, LocalDateTime data, double valor) {
